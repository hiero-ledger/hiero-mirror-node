...
dependencies {
    constraints {
        ...
        api("io.vertx:vertx-core:5.0.1") // Temporary until next Spring Boot
        api("io.vertx:vertx-web:5.0.1") // Temporary until next Spring Boot
        api("io.vertx:vertx-web-client:5.0.1") // Temporary until next Spring Boot
