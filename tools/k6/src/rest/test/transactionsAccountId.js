...
const getUrl = (testParameters) =>
  `/transactions?account.id=${testParameters['DEFAULT_ACCOUNT_ID']}&timestamp=lte:${testParameters['DEFAULT_MAX_BLOCK_TIMESTAMP']}&limit=${testParameters['DEFAULT_LIMIT']}`;
...
const {options, run, setup} = new RestTestScenarioBuilder()
  ...
  .requiredParameters('DEFAULT_ACCOUNT_ID', 'DEFAULT_MAX_BLOCK_TIMESTAMP')
