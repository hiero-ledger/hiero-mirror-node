...
| HISTORICAL_BLOCK_NUMBER                                   |         | 19 decimal digit numeric value representing a block number used to run a test scenario with this block number passed in the request body                                          |
