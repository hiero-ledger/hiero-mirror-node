...
public class BaseTokenHandler {
    ...
    protected long changeSupply(
        ...
        final var aliasedAccount = accountStore.getAliasedAccountById(token.treasuryAccountIdOrElse(AccountID.DEFAULT));
        validateTrue(
                treasuryRel.accountId().equals(aliasedAccount.accountId())
