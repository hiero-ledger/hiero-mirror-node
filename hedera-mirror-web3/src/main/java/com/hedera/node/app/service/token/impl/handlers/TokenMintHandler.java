...
public class TokenMintHandler extends BaseTokenHandler implements TransactionHandler {
    ...
    public void handle(@NonNull final HandleContext context) throws HandleException {
        ...
        final var treasuryAccount = accountStore.getAliasedAccountById(token.treasuryAccountIdOrElse(AccountID.DEFAULT));
        final var treasuryRel = TokenHandlerHelper.getIfUsable(treasuryAccount.accountId(), tokenId, tokenRelStore);
