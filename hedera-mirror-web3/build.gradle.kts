...
val moveTestHistoricalFiles =
    tasks.register<Copy>("moveTestHistoricalFiles") {
        ...
        val base = layout.buildDirectory.dir("generated/sources/web3j").get()
        val srcDir = base.dir("testHistorical/java/com/hedera/mirror/web3/web3j/generated").asFile
        val destDir = base.dir("test/java/com/hedera/mirror/web3/web3j/generated").asFile
