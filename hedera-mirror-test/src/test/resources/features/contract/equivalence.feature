...
Feature: in-equivalence tests
  ...
  and selfdestruct op codes
    ...
    Then I execute balance opcode to system account num <strictSystemAccountNum> would return 0
    Then I verify extcodesize opcode against a system account num <accountNum> returns 0
    Then I verify extcodecopy opcode against a system account num <accountNum> returns empty bytes
    Then I verify extcodehash opcode against a system account num <accountNum> returns empty bytes
    Examples:
