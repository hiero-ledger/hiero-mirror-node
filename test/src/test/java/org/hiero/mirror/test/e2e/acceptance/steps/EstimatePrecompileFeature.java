...
public class EstimatePrecompileFeature extends AbstractEstimateFeature {
    ...
    public enum ContractMethods implements ContractMethodInterface {
        ...
        GET_TOKEN_DEFAULT_KYC_STATUS("getTokenDefaultKyc", 26400, MUTABLE),
        ...
        GET_TOKEN_TYPE("getType", 26380, MUTABLE),
        ...
        NAME_NFT("nameIERC721", 29025, VIEW),
        ...
        TRANSFER_NFTS("transferNFTsExternal", 50311, MUTABLE),
        ...
        WIPE_FUNGIBLE_TOKEN_GET_TOTAL_SUPPLY_AND_BALANCE("wipeTokenGetTotalSupplyAndBalanceOfAccount", 94750, MUTABLE),
        WIPE_NFT_ACCOUNT("wipeTokenAccountNFTExternal", 40394, MUTABLE),
        WIPE_NFT_GET_TOTAL_SUPPLY_AND_BALANCE("wipeTokenGetTotalSupplyAndBalanceOfAccount", 95358, MUTABLE),
