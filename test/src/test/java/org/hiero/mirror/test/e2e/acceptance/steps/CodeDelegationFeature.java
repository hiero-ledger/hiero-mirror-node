...
public class CodeDelegationFeature extends AbstractFeature {
    ...
    public void createContractForCodeDelegation() {
        delegatedContract = getContract(ContractResource.PARENT_CONTRACT);
    ...
    public void createSignerAndAuthorityAccounts() {
        signerAccount = accountClient.createNewAccount(SIGNER_BALANCE, AccountNameEnum.BOB);
        account = accountClient.createNewAccount(SIGNER_BALANCE, AccountNameEnum.BOB);
    ...
    public void executeDelegatedAccountViaEip7702() {
        ...
        assertThat(result.contractFunctionResult()).isNotNull();
    ...
    public void verifyAuthorizationList() {
        ...
        assertThat(restAuthorization.getChainId()).isEqualToIgnoringCase(toQuantityHex(authorization.getChainId()));
        assertThat(restAuthorization.getNonce())
                .isEqualTo(authorization.getNonce().longValueExact());
        assertThat(restAuthorization.getyParity()).isEqualToIgnoringCase(toQuantityHex(authorization.getYParity()));
    ...
    public void callDelegatedAccountViaMirrorNode() {
        var contractCallRequest = ModelBuilder.contractCallRequest()
                ...
                .to(account.getAccountId().toEvmAddress());
