...
| `hiero.mirror.test.acceptance.maxRetries`                        | 8                                            | The number of times client should retry mirror node on supported failures.                                                                             |
...
| `hiero.mirror.test.acceptance.rest.retryOnBadRequestException`   | true                                         | Whether to retry on BAD_REQUEST exceptions due to connection issues.                                                                                   |
