...
class MirrorEntityAccessTest {
    ...
    void getStorage() {
        ...
        when(contractStateService.findSlotValue(ENTITY, BYTES.toArrayUnsafe())).thenReturn(Optional.of(DATA));
    ...
    void getStorageHistorical() {
        ...
        when(contractStateService.findStorageByBlockTimestamp(ENTITY, trimmedKey, timestamp.get()))
