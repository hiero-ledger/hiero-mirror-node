...
class TransactionExecutionServiceTest {
    ...
    void executeUsesHistoricalConsensusEndFromRecordFile() {
        ...
        assertThat(body.getValue().transactionID().transactionValidStart())
                .isEqualTo(new Timestamp(expected.getEpochSecond(), expected.getNano()));
    }
    ...
    void executePrefersConsensusTimestampOverPreviousBlockTimestampOnHourBoundary() {
        ...
        final var params = ContractExecutionParameters.builder()
                ...
                .build();
        ContractCallContext.get().setCallServiceParameters(params);
        ContractCallContext.get().setConsensusTimestamp(Optional.of(consensusNanos));
