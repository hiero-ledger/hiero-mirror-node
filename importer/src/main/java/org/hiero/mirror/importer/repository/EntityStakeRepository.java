...
public interface EntityStakeRepository extends CrudRepository<EntityStake, Long>, EntityStakeRepositoryCustom {
    ...
    /**
     * Updates entity stake for a chunk of entity ids. Requires {@link EntityStakeRepositoryCustom#createEntityStateStart}
     * for the same period beforehand. Must be invoked within a caller-managed transaction together with
     * {@link EntityStakeRepositoryCustom#saveProgress}.
     */
    @Modifying
    @Query(value = """
            truncate table entity_stake_temp;
    ...
    void updateEntityStakeChunk(
            ...
            long endStakePeriod,
            long startEntityIdExclusive,
            long endEntityIdInclusive,
            boolean includeStakingRewardAccount);
}
