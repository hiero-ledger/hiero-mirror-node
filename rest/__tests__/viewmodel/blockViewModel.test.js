...
describe('BlockViewModel', () => {
  const defaultRecordFile = new RecordFile({
    ...
    receipts_root: Buffer.from('56e91f271bcc54a6ff8345e692c0f86e5b48e21b936caed001722fb5e363b425', 'hex'),
    size: 4,
  });
  ...
  test('nullable receipts_root', () => {
    expect(new BlockViewModel(new RecordFile({receipts_root: null})).receipts_root).toStrictEqual(null);
  });

  test('receipts_root hex encoded', () => {
    const buffer = Buffer.from('56e91f271bcc54a6ff8345e692c0f86e5b48e21b936caed001722fb5e363b425', 'hex');
    expect(new BlockViewModel(new RecordFile({receipts_root: buffer})).receipts_root).toStrictEqual(
      '0x56e91f271bcc54a6ff8345e692c0f86e5b48e21b936caed001722fb5e363b425'
    );
  });
});
